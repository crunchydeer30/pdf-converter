...
export default function Product({ theme, children, href }: ProductProps) {
  return (
    <Link
      href={href}
      scroll={true}
      className={`realtive text-s-1 bg-${theme.color}-very-light border-[1px] flex flex-col gap-4 items-center justify-center rounded-lg p-6`}
    >
      <svg className="w-10 h-10 hover:scale-[1.15] transition">
